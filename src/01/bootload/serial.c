...
#define H8_3096F_SCI0 ((volatile struct h8_3096f_sci *)0xffffb0)
#define H8_3096F_SCI1 ((volatile struct h8_3096f_sci *)0xffffb8)
#define H8_3096F_SCI2 ((volatile struct h8_3096f_sci *)0xffffc0)
...
#define H8_3096F_SCI_SMR_CKS_PER4   (1 << 0)
#define H8_3096F_SCI_SMR_CKS_PER16  (2 << 0)
#define H8_3096F_SCI_SMR_CKS_PER64  (3 << 0)
...
#define H8_3096F_SCI_SCR_RIE  (1 << 6)
...
#define H8_3096F_SCI_SSR_RDRF   (1 << 6)
#define H8_3096F_SCI_SSR_TDRE   (1 << 7)

static struct {
    volatile struct h8_3096f_sci *sci;
} regs[SERIAL_SCI_NUM] = {
    { H8_3096F_SCI0 },
    { H8_3096F_SCI1 },
    { H8_3096F_SCI2 },
...
int serial_init(int index) {
    volatile struct h8_3096f_sci *sci = regs[index].sci;
